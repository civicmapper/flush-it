 ...
 */
function traceAnimatePrep(geometryCollection) {
    // exploded the dissolved line to points
    var exploded = turf.explode(geometryCollection);
    ...
    console.log(trwwTracePoints.getPopup());
    return exploded;
}
...
function traceAnimate(tracePoints) {
    ...
    var collection = tracePoints;
    var featuresdata = tracePoints.features;
    ...
    var begend = g.selectAll(".sewerPoints")
        .data(originANDdestination)
        .enter()
        .append("circle", ".sewerPoints")
        .attr("r", 5)
        .style("fill", "red")
        .style("opacity", "1");
